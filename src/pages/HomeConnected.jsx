        ...
        <div className="flex w-full max-lg:w-auto sm:w-{400} sm:p-2 h-96 justify-around mt-5">
            <div className="h-full w-1/2 p-5">
                ...
                ">
                    ...
                    <div className=" auto max-lg:w-auto p-5 md:w-auto">
                            ...
                            <div className="bg-blue-500 max-lg:h-1  w-full h-2 rounded-full my-2"></div>

                            <div className="text-3xl max-lg:text-sm max-xl:text-lg ">Solde: {user.soldeActuel} Ar</div>
                    </div>
                </div>
