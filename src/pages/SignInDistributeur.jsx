...
import userIcon from "/src/assets/male_user_512px.png"
...
export const SignInDistributeur = ()=>{
    ...
    let changeStepUp = ()=>{
        ...
        setStep(s=>s = s + 1)
                ...
                setMessage("Veuillez mettre le code")
                setSuccess(false)
                setIsOpen(true)
...
<>
<div className="w-20 h-20 bg-white rounded-full absolute -top-12 p-4">
  <img src={lockIcon} className="w-10 h-10"  />
</div>
